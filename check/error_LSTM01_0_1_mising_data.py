...
model=load_model('D:/MITECH/2020/LSTM/LSTM01_input_x_c_20_40_1_eps100_bz32.h5')
print("Loaded model from disk")


predictions=numpy.zeros(shape_0)
for i in range(shape_0): # So bo thu
    print(i)
    test = arr.array('f',)
    for k in range (20):
    ...
    for j in range(20):
        test2 = arr.array('f',)
        test1=test
        test1=numpy.reshape(test1, (1,1,20 )) #Sua de phu hop voi tung model o day
...
predictions = predictions.reshape(-1,1) # Can chuyen doi vi co MinMaxScaler
